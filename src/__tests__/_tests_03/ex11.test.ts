...
describe('posição do produto acumulado', () => {
    test('devolve a posição onde o produto acumulado dos numeros da lista ultrapassa o numero introduzido a lista de 2 3 4 5 6 e o numero 720 o resultado deve ser -1', () => {

        //arrange

        const lista:number []= [2,3,4,5,6];
        const numero:number= 720;
        const resultadoEsperado=-1;
