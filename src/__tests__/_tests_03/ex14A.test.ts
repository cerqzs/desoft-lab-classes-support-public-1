...
describe(' canicultura', () => {
    test('se o peso for até 10kg e a alimentação 100g retorna 0 se for mais retorna 1 se for abaixo retorna -1', () => {
...
describe(' canicultura', () => {
    test('se o peso for + de 10kg e <=25kg e a alimentação 250g retorna 0 se for mais retorna 1 se for abaixo retorna -1', () => {
...
describe(' canicultura', () => {
    test('se o peso for >25kg e <=45kg e a alimentação 300g retorna 0 se for mais retorna 1 se for abaixo retorna -1', () => {
...
describe(' canicultura', () => {
    test('se o peso for > 45 e a alimentação 500g retorna 0 se for mais retorna 1 se for abaixo retorna -1', () => {
